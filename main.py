...
def updateDirewolfConf():
    ...
    "TBEACON delay=0 DELAY=0:30 EVERY=1:00 SYMBOL=Balloon VIA=KI5KFW-10,WIDE2-2 COMMENT=\"LEE Send2Space High-Altitude Balloon\" POWER=5 height=5 gain=2\n",
    "IGTXLIMIT 6 10 \n",
...
def main(argv):
    ...
    while True:
        ...
        hours = dT.hour
        mins = dT.minute
        timestring = str(days).zfill(2) + str(hours).zfill(2) + str(mins).zfill(2)
